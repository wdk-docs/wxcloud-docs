:wxcloud:`db.Geo <reference-server-api/database/db.geo>`
===============================================================================
...
.. js:function:: cloud.database.Geo.Point(longitude, latitude)
...
.. js:function:: cloud.database.Geo.LineString(points)
...
.. js:function:: cloud.database.Geo.Polygon(lineStrings)
...
.. js:function:: cloud.database.Geo.MultiPoint(points)
...
.. js:function:: cloud.database.Geo.MultiLineString(lineStrings)
...
.. js:function:: cloud.database.Geo.MultiPolygon(polygons)
